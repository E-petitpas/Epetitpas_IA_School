...
export const AdminApp: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "users":
        return <UserManagementPage user={user} session={{ user }} />;
      case "subscriptions":
        return <SubscriptionManagementPage user={user} session={{ user }} />;
      case "security":
        return <AdminSecurityPage user={user} session={{ user }} />;
      default:
        return <AdminDashboard user={user} session={{ user }} />;
    }
  };
